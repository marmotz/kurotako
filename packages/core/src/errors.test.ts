...
describe('errors', () => {
  ...
  it('OutputNotGeneratedError explains the marker and how to unblock the path', () => {
    const error = new OutputNotGeneratedError('/pkgs/example-tasks');
    expect(error.message).toContain(
      "refusing to overwrite '/pkgs/example-tasks'",
    );
    expect(error.message).toContain('"//": "Generated by tako. Do not edit."');
    expect(error.message).toContain('delete the directory');
  });
