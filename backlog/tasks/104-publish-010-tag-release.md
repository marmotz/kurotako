# Release — dry-run, publish 0.1.0, tag and GitHub Release
...
3. Confirm all 8 packages are live on npm at `0.1.0` under the `latest` tag, with a
   provenance badge.
4. Tag `v0.1.0` on the release commit; create a GitHub Release whose notes summarise
   the MVP surface and link the archived features
   (`backlog/_archives/done.md`).
