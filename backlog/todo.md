...
| [ ] | [#104](https://github.com/marmotz/kurotako/issues/104) | [104-publish-010-tag-release](tasks/104-publish-010-tag-release.md) | Dry-run, publish 0.1.0 to npm, verify per-package tags + GitHub Releases, scratch-project smoke test |
