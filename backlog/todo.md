...
|------|--------------------------------------------------------|-----------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| [ ]  | [#112](https://github.com/marmotz/kurotako/issues/112) | [112-ir-union-schema-types](tasks/112-ir-union-schema-types.md)       | `schemas.ts` `ref`/`union` kinds + `TypeAlias` + `SourceIR.typeAliases?`, recursive `FieldType`, `IR_VERSION = '2'` |
| [ ]  | [#113](https://github.com/marmotz/kurotako/issues/113) | [113-ir-union-validation](tasks/113-ir-union-validation.md)           | `validate.ts` recursive field-type walk, alias pass, non-fatal cycle `info` channel, new `IrIssueCode`s             |
| [ ]  | [#114](https://github.com/marmotz/kurotako/issues/114) | [114-ir-union-builder-helpers](tasks/114-ir-union-builder-helpers.md) | builder `f.ref` / `f.union` / `addTypeAlias`, helpers `resolveRef` / `flattenUnion`, exhaustive `scalarTsType`      |
