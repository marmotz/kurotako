...
1. `apps/docs/docs/getting-started/quick-start.md` — install `tako`, `tako init`, first
   ...
   [cli/technical.md §Command surface](https://github.com/marmotz/kurotako/blob/main/backlog/_archives/features/cli/technical.md#command-surface-clits).
...
4. `apps/docs/docs/reference/tako-config.md` — full `tako.config.ts` reference:
   ...
   [config-system/technical.md](https://github.com/marmotz/kurotako/blob/main/backlog/_archives/features/config-system/technical.md).
...
7. `apps/docs/docs/reference/output-modes.md` — mode A (directory, default) vs mode B
   ...
   [output-modes/technical.md](https://github.com/marmotz/kurotako/blob/main/backlog/_archives/features/output-modes/technical.md)
