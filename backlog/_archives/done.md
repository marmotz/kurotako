# Backlog — archived (done)

Features fully implemented and merged, moved out of [`../todo.md`](../todo.md) by the
`backlog-archive` skill. Feature folders live under [`features/`](features/), their task
files under [`tasks/`](tasks/).
