...
`parser` input, N `generator` outputs, wired by private generator dependencies. Angular is a
first-class output target (React + TanStack Form is supported too), and several parsers can run in parallel, isolated by namespace.
...
- [`docs/architecture.md`](docs/architecture.md) — parsers, generators, private dependencies, IR, output modes
